      ...
      <div className="w-full">
        ...
        >
          {eventData.map((event, index) => (
            <motion.div
              key={event.id}
              className="flex w-full justify-between py-8 px-6 flex-col items-center gap-8 flex-shrink-0 rounded-xl border-2 border-[#88d1d8] bg-gradient-to-r from-[rgba(136,209,216,0.14)] to-[rgba(200,238,241,0.14)]"
